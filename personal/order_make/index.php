...
?><?$APPLICATION->IncludeComponent("bitrix:sale.order.ajax", "order", Array(
	"ACTION_VARIABLE" => "soa-action",	// Название переменной, в которой передается действие
		"ADDITIONAL_PICT_PROP_15" => "-",	// Дополнительная картинка [Каталог]
		"ADDITIONAL_PICT_PROP_16" => "-",	// Дополнительная картинка [Предложения]
		"ADDITIONAL_PICT_PROP_4" => "-",	// Дополнительная картинка [Статьи]
